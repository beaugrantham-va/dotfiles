...
local system_themes_path = filesystem.get_themes_dir()
local local_themes_path  = filesystem.get_configuration_dir() .. "themes/"
local dpi                = require("beautiful.xresources").apply_dpi

-- {{{ Main
local theme                = {}
theme.wallpaper            = local_themes_path .. "zenburn-based/wallpaper.png"
